...
const dict = {
  en: {
    ...
    "navGroup.overview": "Overview", "navGroup.service": "Service",
    "navGroup.ops": "Operations",
    "login.tagline": "Proxy management console",
    "login.hint": "Default account: admin / admin — change it after first sign-in",
    ...
    "common.created": "Created", "common.deleted": "Deleted", "common.saved": "Saved",
  ...
  fa: {
    ...
    "navGroup.overview": "نمای کلی", "navGroup.service": "سرویس",
    "navGroup.ops": "عملیات",
    "login.tagline": "کنسول مدیریت پروکسی",
    "login.hint": "حساب پیش‌فرض: admin / admin — پس از ورود تغییر دهید",
    ...
    "common.created": "ایجاد شد", "common.deleted": "حذف شد", "common.saved": "ذخیره شد",
