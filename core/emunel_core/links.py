...
Ported from RVG's generate_share_link, restricted to the protocols EMUNEL
Core supports (MTProto is not part of EMUNEL Core v1).
"""
...
def generate_share_link(link: Link, host: str, remark_prefix: str = "EMUNEL",
                        path_prefix: str = "") -> str:
...
def subscription_payload(links: list[Link], host: str, title: str = "EMUNEL") -> tuple[str, dict]:
