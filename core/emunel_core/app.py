"""FastAPI application assembly for EMUNEL Core.
...
* Management API (Bearer token via EMUNEL_CORE_API_TOKEN), consumed by the
  EMUNEL Worker on behalf of the Console:
...
class Core:
    ...
    def __init__(self, cfg: CoreConfig):
        ...
        self.app = FastAPI(title="EMUNEL Core", docs_url=None, redoc_url=None,
