  ...
  <div class="shell">
    <aside class="sidebar">
      <div class="brand">
        ...
        <div><div class="brand-name">EMUNEL</div><div class="brand-sub">Console</div></div>
      </div>
    ...
    <div class="main">
      <div class="topbar">
        <div class="brand">
          <span class="brand-mark" style="color:var(--accent)">${mark}</span>
          <div><div class="brand-name">EMUNEL</div></div>
        </div>
...
boot().catch((err) => {
  document.getElementById("app").innerHTML = `<div class="login-wrap"><div class="login-card">
    <div class="card"><h3>EMUNEL Console failed to load</h3>
