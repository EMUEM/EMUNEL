      ...
      el.innerHTML = `
        ...
        <div class="card" style="background:var(--bg-raised)">
          ...
          <p class="faint" style="margin:10px 0 0;font-size:12.5px">
            WebSocket, xHTTP and all EMUNEL protocols work through this endpoint with automatic TLS.
            A provider hostname (e.g. <span class="mono-sm">name-xxxx.emunel.app</span>) is attached
